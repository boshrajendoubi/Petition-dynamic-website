...
<div class="containerrr">
    <div class="avatar-upload">
        <div class="avatar-edit">
            <input type='file' id="imageUpload" class="form-control input-lg"  accept=".png, .jpg, .jpeg" />
            <label for="imageUpload"  class="form-label"></label>
        </div>
        <div class="avatar-preview">
            <div id="imagePreview" style="background-image: url('images/petition.jpg');">
            </div>
        </div>
    </div>
</div>
...
<div class="contain">
  ...
  <div class="row">
    ...
    <fieldset class="select-account marginl50">
      <button type="button" id="choose-account" name="choose-account" class="choose-account" aria-haspopup="true" value="credit-cards">Catégorie</button>
  ...
  $select.on("click", "label", function() {
    ...
    $select.removeClass("active");
     ...
     <div class="mb-3 formsign form-group-lg" >
      ...
      <input type="text" class="form-control input-lg" id="validationCustom01" placeholder="Titre" required name="titre">
     ...
     <div class="mb-3 formsign">
       ...
       <textarea class="form-control input-lg" id="validationTextarea" placeholder="Description" required name="description"></textarea>
       <div class="invalid-feedback">
     ...
     <div class="col-3 formsign ">
       <button class="bttn" type="submit">Lancer une pétition</button>
     </div>
...
<!-- old yekhdem jawou  bhey w handouda aatba-->
<?php
include 'session-verif.php';
?>
...
<head>
 ...
 <link rel='stylesheet' href='https://use.fontawesome.com/releases/v5.3.1/css/all.css'>
  ...
  <link rel="stylesheet" type="text/css" href="creerpetition-final.css">
...
<div class="containerrr">
    <div class="avatar-upload">
        ...
        <div class="avatar-preview">
            <div id="imagePreview" style="background-image: url('images/testttt.jpg');">
            </div>
        </div>
    </div>
</div>
